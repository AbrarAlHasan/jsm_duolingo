  ...
  return (
    <SafeAreaView className="flex-1 bg-app">
      ...
      <View className="flex-1 px-6">
        ...
        {/* Headline — left-aligned like design */}
        ...
        {/* CTA — label centered, chevron on the right (matches design) */}
        <Pressable
          className="bg-lingua-purple relative mb-8 h-[56px] w-full justify-center rounded-full active:opacity-90"
          onPress={() => {}}
        >
